...
If you have not cloned this repository to your virtual machine, do so now. All of the artifacts for this lab are located under `starter-artifacts/azure-notebooks`.

## Exercise 1 - Get oriented to the lab files
1. On your virtual machine expand the folder `06_deploy_to_iot_edge`.<br/>
2. To run a lab, start **Azure Notebook** and open the folder: `06_deploy_to_iot_edge` and click the starting python file: `06_deploy_to_iot_edge.py`.<br/>
...
1. Return to **Azure Notebook** and `06_deploy_to_iot_edge.py`.
